...
const MessageContainer = () => {
  ...
  const { selectedChatData, selectedChatType, selectedChatMessages, setSelectedChatMessages, setFileDownloadProgress, setIsDownloadingFile } = useAppStore();
  ...
  const downloadFile = async (fileUrl) => {
    ...
    const response = await apiClient.get(`${HOST}/${fileUrl}`, { responseType: 'blob', withCredentials: true,
